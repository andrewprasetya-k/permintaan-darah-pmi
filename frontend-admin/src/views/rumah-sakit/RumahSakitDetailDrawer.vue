...
import { X, Building2, AtSign, Mail, Phone, MapPin, Calendar, Clock } from '@lucide/vue'

defineProps<{ isOpen: boolean }>()
defineEmits<{ close: [] }>()

const rumahSakitStore = useRumahSakitStore()
const rs = computed(() => rumahSakitStore.selectedRumahSakit)
      ...
      >
        <div class="flex items-center justify-between px-10 py-8 border-b border-gray-100">
          <div>
            ...
            <p class="text-sm text-gray-400 mt-0.5">{{ rs?.nama }}</p>
          </div>
          <button
            @click="$emit('close')"
        ...
        <div v-if="rs" class="flex-1 overflow-y-auto px-10 py-8 space-y-6">
          <!-- Info Fields -->
          <div class="bg-white border border-gray-100 rounded-2xl divide-y divide-gray-50">
            <div class="flex items-center gap-4 px-6 py-4">
              ...
              <div>
                ...
                <p class="text-sm font-medium text-gray-900 mt-0.5">{{ rs.nama }}</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 px-6 py-4">
              ...
              <div>
                ...
                <p class="text-sm font-medium text-gray-900 mt-0.5">{{ rs.username }}</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 px-6 py-4">
              ...
              <div>
                ...
                <p class="text-sm font-medium text-gray-900 mt-0.5">{{ rs.email || '—' }}</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 px-6 py-4">
              ...
              <div>
                ...
                <p class="text-sm font-medium text-gray-900 mt-0.5">{{ rs.nomorTelepon }}</p>
              </div>
            </div>

            <div class="flex items-start gap-4 px-6 py-4">
              <div
                class="w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center shrink-0 mt-0.5"
              >
                <MapPin :size="14" class="text-gray-400" />
              </div>
              <div>
                <p class="text-xs text-gray-400 uppercase tracking-wide font-medium">Alamat</p>
          ...
          <div class="bg-white border border-gray-100 rounded-2xl divide-y divide-gray-50">
            <div class="flex items-center gap-4 px-6 py-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 mt-0.5">{{ formatDate(rs.createdAt) }}</p>
              </div>
            </div>
            <div class="flex items-center gap-4 px-6 py-4">
              <div class="w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 mt-0.5">{{ formatDate(rs.updatedAt) }}</p>
              </div>
            </div>
          </div>
