...
<template>
  <div class="mx-auto flex h-full min-h-0 max-w-4xl flex-col">
    <div
      class="grid min-h-0 flex-1 gap-6 lg:grid-cols-[320px_minmax(0,1fr)]"
    >
      <section class="rounded-2xl border border-gray-100 bg-white p-6">
        ...
        <div class="mt-6 space-y-4 border-t border-gray-100 pt-6">
          <div class="rounded-xl bg-gray-50 px-4 py-3">
            ...
            <div class="mt-2 inline-flex items-center gap-2 rounded-lg bg-white px-3 py-1.5 text-sm font-medium text-gray-700">
      ...
      <section class="rounded-2xl border border-gray-100 bg-white">
        ...
        <form class="space-y-5 px-6 py-6" @submit.prevent="handleSubmit">
          <div>
            ...
            <div class="relative">
              <AtSign :size="16" class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
              <input
          ...
          <div>
            ...
            <div class="relative">
              <UserRound :size="16" class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
              <input
          ...
          <div>
            ...
            <div class="relative">
              <Mail :size="16" class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
              <input
